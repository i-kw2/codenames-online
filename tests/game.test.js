...
// V10 image assignment tests / اختبارات توزيع صور البطاقات في V10
(function () {
  'use strict';
  const H = window.TestHarness;
  const G = window.Codenames.Game;

  H.test('V10 createBoard assigns all 25 unique reveal images', () => {
    const board = G.createBoard(window.Codenames.DEFAULT_WORDS, 'red');
  ...
  H.test('V10 new boards reshuffle reveal image positions', () => {
