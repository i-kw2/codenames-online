...
function cacheDom() {
  [
    'onlineHomeSection','lobbySection','firebaseConnectionBadge','firebaseSetupWarning','hostNameInput','createRoomBtn',
...
function renderShell() {
  ...
  if (runtime.roomCode) {
    dom.lobbyRoomCode.textContent = runtime.roomCode;
    dom.onlineGameRoomCode.textContent = runtime.roomCode;
