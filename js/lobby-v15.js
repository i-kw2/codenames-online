(function (global) {
  ...
  function translateSecondaryUi() {
    ...
    if(refs.newsDialogV14){const h=refs.newsDialogV14.querySelector('h2'),p=refs.newsDialogV14.querySelector('p'); if(h)h.textContent=q('News','الأخبار'); if(p)p.textContent=q('V15 restores the V13 color system and completes the redesigned room lobby, Spectators thumbnails, team role panels, Settings tabs, contextual Quick Guide, team locking, and accessibility preferences while keeping the V13 game engine intact.','يعيد V15 ألوان V13 ويكمل تصميم Lobby، صور المشاهدين المصغرة، لوحات أدوار الفرق، تبويبات الإعدادات، الدليل السريع السياقي، قفل الفرق، وخيارات إمكانية الوصول مع الحفاظ على محرك V13.');}
  }
