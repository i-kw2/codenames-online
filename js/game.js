(function (global) {
  ...
  // V11: use the untouched source PNG artwork and tint it only at display time.
  // V11: نستخدم صور PNG الأصلية دون تعديل، ويُطبق اللون فقط وقت العرض.
  const REVEAL_CARD_IMAGES = Object.freeze([
    'assets/cards/original/001_NN_Man.png', 'assets/cards/original/002_NN_Man.png', 'assets/cards/original/003_NN_Man.png', 'assets/cards/original/004_NN_Man.png', 'assets/cards/original/005_NN_Man.png',
    'assets/cards/original/006_NN_Woman.png', 'assets/cards/original/007_NN_Woman.png', 'assets/cards/original/008_NN_Woman.png', 'assets/cards/original/009_NN_Woman.png', 'assets/cards/original/010_NN_Woman.png',
    'assets/cards/original/011_NN_Animal.png', 'assets/cards/original/012_NN_Animal.png', 'assets/cards/original/013_NN_Animal.png', 'assets/cards/original/014_NN_Animal.png', 'assets/cards/original/015_NN_Animal.png',
    'assets/cards/original/016_NN_Kids.png', 'assets/cards/original/017_NN_Kids.png', 'assets/cards/original/018_NN_Kids.png', 'assets/cards/original/019_NN_Kids.png', 'assets/cards/original/020_NN_Kids.png',
    'assets/cards/original/021_NN_Maid.png', 'assets/cards/original/022_NN_Maid.png', 'assets/cards/original/023_NN_Maid.png', 'assets/cards/original/024_NN_Maid.png', 'assets/cards/original/025_NN_Maid.png'
  ]);
