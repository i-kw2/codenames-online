(function (global) {
  ...
  function replaceState(nextState, shouldNotify) {
    ...
    if (!gameState.candidateSelection) gameState.candidateSelection = { team: null, cardIds: [], clueSubmittedAt: null, updatedAt: null, updatedBy: null };
  ...
  function ensureCandidateSelectionContext() {
    const submittedAt = gameState.currentClue ? gameState.currentClue.submittedAt : null;
    if (!gameState.candidateSelection || gameState.candidateSelection.team !== gameState.currentTeam || gameState.candidateSelection.clueSubmittedAt !== submittedAt) {
  ...
  CN.Game = {
    ...
    randomiseSpymasters,
    __test: {
      replaceState(nextState) { gameState = nextState; transitionLock = false; },
      blankState,
