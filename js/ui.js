(function (global) {
  ...
  function renderGame(state) {
    ...
    // بالأونلاين القائد يرى المفتاح تلقائياً، لذلك نخفي زر المفتاح والعودة للاعبين بالكامل.
    ...
    // Online game-management controls are visible to the room creator/host only.
    // أزرار إدارة الجولة لا تظهر إلا لمن أنشأ الغرفة.
