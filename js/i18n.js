(function (global) {
  ...
  const STRINGS = {
    ar: {
      ...
      rolesVisibleWarning: 'المفتاح السري ظاهر الآن. أخفه قبل إعادة الجهاز للاعبين.', picked: 'تم اختيارها', soundOn: 'الصوت يعمل', soundOff: 'الصوت مكتوم',
      redTurn: 'دور الفريق الأحمر', blueTurn: 'دور الفريق الأزرق', wrongPick: 'اختيار خاطئ!', wrongTurnHandoff: 'الدور ينتقل للفريق الآخر'
    },
    en: {
      ...
      rolesVisibleWarning: 'The secret key is visible. Hide it before returning the device to operatives.', picked: 'Picked', soundOn: 'Sound on', soundOff: 'Sound muted',
      redTurn: 'Red Team Turn', blueTurn: 'Blue Team Turn', wrongPick: 'Wrong choice!', wrongTurnHandoff: 'Turn switches to the other team'
    }
  };
