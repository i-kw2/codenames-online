...
## V14 — Lobby / Settings / Spectators redesign

V14 keeps the V13 game engine and rebuilds the **online lobby** to match the supplied reference layout: Spectators at the upper center, Blue Team on the left, Game Settings in the center, Red Team on the right, and a large Start Game action below.
...
**Deployment note:** V14 updates `firebase-rules.json`. Re-publish the Realtime Database rules before testing the new lobby permissions. Existing V13 gameplay, board roles, clue logic, scoring, reveal images, and Spymaster view behavior are intentionally preserved.
