# Codenames Bilingual V7 — Local + Online Multiplayer
...
- Direct guessing: during the guessing phase, an eligible Operative clicks one unrevealed card to submit that guess immediately. There is no candidate-card stage.
